...
function Settings() {
  ...
  useEffect(() => {
    const fetchPrivacy = async () => {
      ...
      setPrivacyMode(data.isPrivate ? "private" : "everyone");
    };
  ...
  const updatePrivacy = async (setting) => {
    try {
      ...
      await fetch(`${API_URL}/api/profile/privacy`, {
        method: "PUT",
        headers: {
  ...
  const handleSelection = (privacySetting) => {
    setPrivacyMode(privacySetting);
    setIsPrivate(privacySetting !== "everyone");
        ...
        <section className="feed settings-feed">
          <div className="feed-wrapper">
            ...
            <div className="settings-option">
              ...
              {showOptions && (
                <div className="privacy-dropdown" ref={dropdownRef}>
                  <button
                  ...
                  <button
                    ...
                    className={privacyMode === "everyone" ? "active" : ""}
                  >
                    {t("settings.public")}
                  </button>

                  <button
                    onClick={() => handleSelection("mutual")}
                    className={privacyMode === "mutual" ? "active" : ""}
                  >
                    Mutual 🤝
                  </button>
                </div>
        ...
        <div className="confirm-modal-overlay" onClick={handleCancel}>
          <div className="confirm-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-buttons">
              ...
              >
                {confirmAction === "logout" ? "Logout" : "Delete"}
              </button>
            </div>
          </div>
        </div>
