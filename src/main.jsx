...
ReactDOM.createRoot(document.getElementById("root")).render(
  <BrowserRouter>
    <Routes>
      ...
      <Route path="/community/:communityId" element={<JoinedCommunity />} />
      <Route
        path="/community/:communityId/chat"
        element={<PublicChat socket={socket} />}
      />
      <Route path="/community/:communityId/bot" element={<CommunityBot />} />
      <Route path="/dm" element={<Dm socket={socket} />} />
      <Route
        path="/dm/chatpage/:userId/:username"
      ...
      <Route
        ...
        element={<StreamRoom socket={socket} />}
      />
    </Routes>
  </BrowserRouter>,
);
